...
const NODE_LAYOUT: DagNodeLayout[] = [
  ...
  { id: "node_hard_block", label: "Hard Block", position: { x: 580, y: 100 } },
  { id: "node_hitl_escalation", label: "HITL Escalation", position: { x: 20, y: 100 } },
  { id: "node_rag_retrieval", label: "RAG Retrieval", position: { x: 300, y: 140 } },
  { id: "node_plan_generation", label: "Plan Generation", position: { x: 300, y: 280 } },
  { id: "node_security_guard", label: "Security Guard", position: { x: 20, y: 440 } },
  { id: "node_hr_guard", label: "HR Guard", position: { x: 200, y: 440 } },
  { id: "node_policy_guard", label: "Policy Guard", position: { x: 400, y: 440 } },
  { id: "node_sla_guard", label: "SLA Guard", position: { x: 580, y: 440 } },
  { id: "node_fan_in_reducer", label: "Fan-In Reducer", position: { x: 300, y: 580 } },
  { id: "node_meta_governance", label: "Meta Governance", position: { x: 300, y: 710 } },
  { id: "node_execution", label: "Execution", position: { x: 300, y: 850 } },
  { id: "node_retry", label: "Retry", position: { x: 580, y: 930 } },
  { id: "node_feedback_loop", label: "Feedback Loop", position: { x: 300, y: 1000 } },
  { id: "node_complete", label: "Complete", position: { x: 300, y: 1120 } },
];
